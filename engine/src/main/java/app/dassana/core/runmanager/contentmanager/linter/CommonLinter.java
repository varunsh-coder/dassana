...
import static app.dassana.core.runmanager.contentmanager.linter.BaseLinter.loadFilesFromPath;
...
public class CommonLinter {
	...
	private final static String[] requiredFields = new String[]{"vendorId", "alertId", "vendorPolicy", "csp",
					"resourceContainer", "region", "resourceId"};
	...
	private StatusMsg requiredFields(Map<String, Object> data){
      ...
      Set<String> requireCopy = new HashSet<>(required);
			...
			statusMsg = new StatusMsg(true,
					"Following required fields are missing from output in normalize workflow : " + requireCopy);
		}
