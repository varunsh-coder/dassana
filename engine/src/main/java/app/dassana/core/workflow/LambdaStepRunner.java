...
public class LambdaStepRunner implements StepRunnerApi {
  ...
  public StepRunResponse runStep(Workflow workflow, Step step, String payLoad,
    ...
    RuntimeContext runtimeContext = getRuntimeContext(workflow,
  ...
  private RuntimeContext getRuntimeContext(Workflow workflow,
    ...
    if (normalizedWorkFlowOutput == null) {
    ...
    if (workflow instanceof ResourcePriorityWorkflow || workflow instanceof ContextWorkflow) {

      JSONObject jsonObject = new JSONObject(normalizedWorkFlowOutput);
