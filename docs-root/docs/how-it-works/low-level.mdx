...
To learn _how_ workflows are executed, please read [this](../guides/workflow-authoring/execution.mdx) document. The rest of the document describes _what_ do they do.
