...
:::tip
This tutorial uses a dummy alert, if you would like to see a real life example, we invite you to vist [this](https://docs.dassana.io/blog/static-s3-bucket) blog.
:::
