...
The workflows of `policy-context` type are intended to provide context around the alert. These workflows should care about the alert actually (as opposed to resource-context workflows which should care about the resource in question)
