...
Have a look at [SecurityHub's](https://github.com/dassana-io/dassana/blob/main/content/workflows/vendors/security-hub/security-hub.yaml) normalizer as an example.
