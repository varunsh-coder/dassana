...
This workflow type is responsible for normalizing alerts received by the engine. As such, the most important part to familiarize yourself is the output section
